...
class VSRPDE : public RegressionBase<VSRPDE, SpaceOnly> {
   private:
    using Base = RegressionBase<VSRPDE, SpaceOnly>;
   ...
   public:
    ...
    // constructor
    VSRPDE() = default;
    VSRPDE(const Base::PDE& pde, Sampling s) : Base(pde, s) {};
